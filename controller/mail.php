...
function sendResetMail($mail, $resetkey)
{
    $resetlink = 'http://localhost:8008/index.php?action=resetpwd&resetkey=' . $resetkey;
    ...
    $message_txt = "Hello, here's your reset link : " . $resetlink;
    $message_html = "<html><head></head><body><b>Hello</b>,
                    here's your reset link : " . $resetlink ." </body></html>";
    $boundary = "-----=".md5(rand());
    
    $sujet = "Lazygram, reset password request";
